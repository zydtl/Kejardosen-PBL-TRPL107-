...
// pencarian khusus untuk tabel lihat bimbingan
function searchTable() {
  // Ambil input pencarian
  const input = document.getElementById('search-input');
  const filter = input.value.toLowerCase();
  const tableRows = document.querySelectorAll('.responsive-table-bimbingan .table-row');
...
// Fungsi pencarian khusus untuk tabel
function searchTable() {
  // Ambil input pencarian
  const input = document.getElementById("search-input");
  const filter = input.value.toLowerCase();
