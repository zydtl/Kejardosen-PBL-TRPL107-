  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-6 order-lg-first order-last bg-left d-flex justify-content-center align-items-center">
        <img src="{{ asset('assets/auth/asset/img/login-mahasiswa.png') }}" alt="Ilustrasi Login" class="login-illustration">
      </div>
      <div class="col-sm-12 col-md-12 col-lg-6 order-lg-last order-first bg-right">
        <div class="row align-items-center">
          ...
          <form action="{{ route('login.mahasiswa') }}" method="POST" class="w-100">
            @csrf
            <div class="input-container mx-auto">
              <label for="usernameInput" class="input-label">👤 NIM</label>
              <input id="usernameInput" type="text" name="nim" class="form-control custom-input" placeholder="masukkan NIM anda ..." required>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6  order-lg-last order-first bg-right">
          <div class="row align-items-center">
            ...
            <div class="input-container mx-auto">
              <label for="usernameInput" class="input-label">👤 NIM</label>
              <input id="usernameInput" type="text" class="form-control custom-input" placeholder="masukkan NIM anda ...">
            </div>
            <div class="input-container mx-auto mt-2">
              <label for="passwordInput" class="input-label">🔐 Kata Sandi</label>
              <div class="input-group">
