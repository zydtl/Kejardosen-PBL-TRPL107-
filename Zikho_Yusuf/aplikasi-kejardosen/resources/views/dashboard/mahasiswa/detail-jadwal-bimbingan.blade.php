...
@section('title')
    Info Jadwal Bimbingan - Mahasiswa
@endsection
...
@section('content')
    <div class="main-content">
        <div class="title-and-button">
            ...
            <a href="{{ route('mahasiswa.jadwal-bimbingan') }}" ><button class="btn btn-primary">Kembali</button></a>
        ...
        <div class="detail">
            ...
            <div class="isi">{{ $jadwal->pengajuan->mahasiswa->dosen->nama_dosen }}</div>
        </div>
        <div class="detail">
            <div class="ket">NIK/NIDN</div>
            <div class="isi">{{ $jadwal->pengajuan->mahasiswa->dosen->nik }}</div>
        </div>
        <div class="detail">
